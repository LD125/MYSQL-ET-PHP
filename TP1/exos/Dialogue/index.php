...
/////////////////---------------- Confirmation de l'enregistrement par un message---------------//////////////////////        
        if ( $db->query($sql) )
        {
            echo '<p class="info">Message enregisré</p>';
        } 
    }  
...
$resul = $db->query("SELECT *, 
                    ...
                    DATE_FORMAT(date_enregistrement,'%H:%i:%s') AS heurefr
                        ...
                        FROM commentaire
                        ORDER BY date_enregistrement DESC"); // Ordonner et mettre les derniers messages en tête de liste
